...
namespace ControleAcessoLivros.Controllers
{
    public class AutoresController : Controller
    {
        ...
        public AutoresController(ControleAcessoLivrosContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("AutorId,NomeAutor,Email")] Autor autor)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("AutorId,NomeAutor,Email")] Autor autor)
        {
            if (id != autor.AutorId)
            {
                return NotFound();
