...
namespace ControleAcessoLivros.Controllers
{
    public class LivrosController : Controller
    {
        ...
        public LivrosController(ControleAcessoLivrosContext context)
        {
            _context = context;
        }
        ...
        {
            var controleAcessoLivrosContext = _context.Livro.Include(l => l.Autor);
        ...
        public async Task<IActionResult> Create([Bind("LivroId,NomeLivro,Genero,AutorId,AnoLancamento")] Livro livro)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("LivroId,NomeLivro,Genero,AutorId,AnoLancamento")] Livro livro)
        {
            if (id != livro.LivroId)
            {
                return NotFound();
